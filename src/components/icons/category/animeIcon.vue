<template>
  ...
  >
    ...
    <g id="SVGRepo_iconCarrier">
      <polygon
        style="fill: #68d1ea"
        points="24,459.2 195.2,288 273.6,367.2 292.8,348 404,459.2 443.2,420 485.6,463.2 461.6,475.2 41.6,471.2 "
      ></polygon>
      <polygon
        style="fill: #27a0d6"
        points="24,459.2 195.2,288 243.2,398.4 292.8,348 387.2,480.8 443.2,420 456,463.2 461.6,475.2 41.6,471.2 "
      ></polygon>
      <path
        style="fill: #272b2b"
      ...
      <path
        style="fill: #6faf00"
        d="M497.6,476.8c0,4.8-3.2,8-8,8H14.4c-4.8,0-8-3.2-8-8V468c0-4.8,3.2-8,8-8h475.2c4.8,0,8,3.2,8,8 V476.8z"
      ></path>
    </g>
  </svg>
</template>
